...
Suppressing missing-CMI warnings for generated aliases must not suppress them
for an unused alias in the user's header. Check inference alone so the final
parser compilation cannot mask this distinction.
