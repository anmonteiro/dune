...
The mock query opens the generated aliases before the grammar's header. Show
the query through that header, including the shadowing guard for the group.
  ...
  (** @canonical Dune__exe.Foo *)
  module Foo = Dune__exe__Foo
  
  (** @canonical Dune__exe.Group *)
  module Group = Dune__exe__Group__Group
  end
  open! struct
  [@@@ocaml.warning "-49"]
  (* generated by dune *)
  
  (** @canonical Dune__exe.Group.M *)
  module M = Dune__exe__Group__M
  
  module Dune__exe__Group__ = struct end
