...
(** Load producers matching a file predicate, without loading aliases or
    unrelated file producers. *)
val load_file_selector : File_selector.t -> Loaded.t Memo.t

(** Load producers contributing to this alias. *)
...
(** Internal directory materialization during file discovery. Only declared
    directory targets use this lookup; ordinary target requests use [get_rule]
    to validate conflicts with file-producing rules. *)
val get_directory_rule : Path.Build.t -> Rule.t option Memo.t
