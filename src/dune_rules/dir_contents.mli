...
(** Source filenames matching [mask], including generated sources. Only source
    producers whose targets may intersect [mask] are evaluated. *)
val text_files : t -> mask:Target_mask.t -> Filename.Array.Set.t Memo.t
